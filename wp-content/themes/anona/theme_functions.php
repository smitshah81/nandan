...
if ( ! function_exists( 'iva_post_metadata' ) ) {
	/**
	 * Print HTML with meta information for the current post-date/time and author.
	 */
	function iva_post_metadata() {

		if ( is_sticky() && is_home() && ! is_paged() ) {
			echo '<span class="iva-pm-featured featured-post">' . __( 'Sticky', 'iva_theme_front' ) . '</span>';
		}
...
function iva_pagination() {
	...
	$links = paginate_links( array(
		...
		'prev_text' => __( '&larr; Previous', 'iva_theme_front' ),
		'next_text' => __( 'Next &rarr;', 'iva_theme_front' ),
	) );
